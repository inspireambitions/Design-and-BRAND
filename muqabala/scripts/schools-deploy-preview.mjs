...
const branch='codex/schools-finish-20260914';
const settings={SCHOOLS_ENABLED:'true',SCHOOLS_FEEDBACK_MODEL:'gpt-4.1-mini',SCHOOLS_INPUT_USD_PER_MILLION:'0.40',SCHOOLS_OUTPUT_USD_PER_MILLION:'1.60',NEXT_PUBLIC_SUPABASE_URL:c.SUPABASE_URL,NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY:c.SUPABASE_PUBLISHABLE_KEY||c.SUPABASE_ANON_KEY,SUPABASE_SECRET_KEY:c.SUPABASE_SERVICE_ROLE_KEY,APP_ORIGIN:'https://muqabala-schools-pilot-20260908-inspire14.vercel.app',INTERVIEW_SECRET:stagingSecret};
...
args.push('--meta','githubDeployment=1','--meta','githubCommitRef='+branch);
