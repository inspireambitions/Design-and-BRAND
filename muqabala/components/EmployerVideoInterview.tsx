...
const COPY = {
  en: {
    ...
    uploadDisclosure: 'Your name and recordings are uploaded securely as you progress. The employer cannot open them until you submit the full interview and give consent.',
  ...
  ar: {
    ...
    uploadDisclosure: 'يتم رفع اسمك وتسجيلاتك بشكل آمن أثناء تقدمك. لا تستطيع جهة العمل فتحها حتى ترسل المقابلة كاملة وتوافق على الإقرار.',
