...
export function SchoolsNavigation(){
  ...
  return <nav aria-label="Schools"><Link href="/schools/me">My assignments</Link><Link href="/schools/cohorts">Cohorts</Link><Link href="/schools/me/settings">Account</Link><SchoolsSignOut/></nav>;
}
