...
export const STRINGS = {
  en: {
    ...
    proofLinkPlacesLabel: 'Candidate places',
    ...
    proofLinkSettingsSummary: 'Up to {count} candidates can start. The link stays open for {days} days.',
  ...
  ar: {
    ...
    proofLinkPlacesLabel: 'عدد المرشحين',
    proofLinkOpenForLabel: 'متاح لمدة',
    proofLinkDaysOption: '{days} أيام',
    proofLinkSettingsHelp: 'يُغلق الرابط عند بلوغ أي من الحدين.',
    proofLinkSettingsSummary: 'يمكن لما يصل إلى {count} مرشحاً البدء. يبقى الرابط مفتوحاً لمدة {days} أيام.',
