...
export const STRINGS = {
  en: {
    ...
    proofCreateBody:
      'Create a focused 12-minute work sample from any job description. You review the answers. Nothing is auto-rejected.',
    proofCreateStepsLabel: 'Create and share a work sample in three steps',
    ...
    proofAdvertLabel: 'Job description',
  ...
  ar: {
    ...
    proofCreateBody:
      'أنشئ عينة عمل مركزة مدتها ١٢ دقيقة من أي وصف وظيفي. أنت تراجع الإجابات. لا يوجد رفض تلقائي.',
    proofCreateStepsLabel: 'أنشئ عينة عمل وشاركها في ثلاث خطوات',
    ...
    proofAdvertLabel: 'الوصف الوظيفي',
