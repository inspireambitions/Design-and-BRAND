...
export const STRINGS = {
  en: {
    ...
    proofCreateBody:
      'Keep your career portal. Paste the advert you already posted. Get a 12-minute work sample. A person decides. Nothing is auto-rejected.',
    proofWorkplaceLabel: 'Workplace name (optional)',
    proofJobTitleLabel: 'Job title',
    proofAdvertLabel: 'Job advert',
    proofCreateAction: 'Create the link',
    proofCopyLink: 'Copy link',
    proofCopied: 'Link copied.',
    proofCreateFailed: 'The work sample could not be created. Paste more of the advert and try again.',
    ...
    proofWorkplacePlaceholder: 'Al Maha Hotel',
    proofJobTitlePlaceholder: 'Front Office Agent',
    proofAdvertPlaceholder: 'Paste the advert from your career portal.',
    proofWhatsApp: 'WhatsApp',
    proofAdvertTooShort: 'Paste more of the advert so we can build the work sample.',
  ...
  ar: {
    ...
    proofCreateBody:
      'أبقِ بوابة التوظيف كما هي. الصق الإعلان المنشور. احصل على عينة عمل من 12 دقيقة. يقرر إنسان. لا رفض تلقائي.',
    proofWorkplaceLabel: 'اسم جهة العمل (اختياري)',
    proofJobTitleLabel: 'المسمى الوظيفي',
    proofAdvertLabel: 'إعلان الوظيفة',
    proofCreateAction: 'إنشاء الرابط',
    proofCopyLink: 'نسخ الرابط',
    proofCopied: 'تم نسخ الرابط.',
    proofCreateFailed: 'تعذر إنشاء عينة العمل. الصق جزءاً أطول من الإعلان وحاول مرة أخرى.',
    ...
    proofWorkplacePlaceholder: 'فندق المها',
    proofJobTitlePlaceholder: 'موظف استقبال',
    proofAdvertPlaceholder: 'الصق الإعلان من بوابة التوظيف.',
    proofWhatsApp: 'واتساب',
    proofAdvertTooShort: 'الصق جزءاً أطول من الإعلان حتى نتمكن من بناء عينة العمل.',
