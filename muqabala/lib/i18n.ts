...
export const STRINGS = {
  en: {
    ...
    proofCreateBody:
      'No career portal needed. Add the company and vacancy title, then paste a job description or generate a clear draft. Get a 12-minute work sample. A person decides. Nothing is auto-rejected.',
    proofCompanyLabel: 'Company name',
    proofRecruiterLabel: 'Recruiter name (optional)',
  ...
  ar: {
    ...
    proofCreateBody:
      'لا حاجة لبوابة توظيف. أضف اسم الشركة والمسمى الوظيفي، ثم الصق الوصف الوظيفي أو أنشئ مسودة واضحة. احصل على عينة عمل من 12 دقيقة. يقرر إنسان. لا رفض تلقائي.',
    proofCompanyLabel: 'اسم الشركة',
    proofRecruiterLabel: 'اسم مسؤول التوظيف (اختياري)',
