...
/**
 * Seven-day plan requests: a few per address in ten minutes, and three per
 * email in a day so nobody can be flooded with plans they did not ask for.
 * The email side is keyed on the server HMAC, never the address itself.
 */
