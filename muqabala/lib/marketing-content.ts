...
export const homeCopy: Localised<Record<string, string>> = {
  ...
  ar: {
    ...
    privacyDetail:
      'يُرسل نص إجابتك إلى خدمة التقييم. قد تستخدم ميزة التعرف على الكلام مزود المتصفح لتحويل الصوت إلى نص. يبقى سجل التدريب المكتمل في هذا المتصفح.',
  ...
  privacy: {
    en: {
      ...
      sections: [
        ...
        { title: 'Your practice history', body: 'Your finished answers, feedback and scores stay in this browser. Clear your browser data to remove them. If you choose to email yourself a private report link, we store the questions, scores, feedback and short evidence extracts for up to 90 days. We do not store your full answers or video in that report. You can delete it sooner.' },
        { title: 'Your anonymous rating', body: 'If you rate the practice, we email the usefulness score, readiness choice, role category, interview score, question count and language to the Muqabala team. We do not include your name, email address, answer text, audio or video. We do not publish the rating unless you separately choose “Yes, share it anonymously”.' },
    ...
    ar: {
      ...
      sections: [
        ...
        { title: 'سجل التدريب', body: 'يُحفظ نص الإجابات المكتملة والملاحظات والدرجات في متصفحك. يؤدي مسح بيانات المتصفح إلى حذف هذا السجل المحلي. إذا اخترت إرسال رابط تقرير خاص إلى بريدك، نحفظ الأسئلة والدرجات والملاحظات ومقتطفات قصيرة من الأدلة لمدة تصل إلى 90 يوماً. لا نحفظ إجاباتك الكاملة أو الفيديو في هذا التقرير، ويمكنك حذفه قبل ذلك.' },
        { title: 'تقييمك المجهول', body: 'إذا قيّمت التدريب، نرسل درجة الفائدة واختيار الاستعداد وفئة الوظيفة ودرجة المقابلة وعدد الأسئلة واللغة إلى فريق مقابلة. لا نرسل اسمك أو بريدك الإلكتروني أو نص إجابتك أو الصوت أو الفيديو. لا ننشر التقييم إلا إذا اخترت بشكل منفصل «نعم، شاركوه دون اسمي».' },
