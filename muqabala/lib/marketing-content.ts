  ...
  privacy: {
    en: {
      ...
      sections: [
        ...
        { title: 'Your anonymous rating', body: 'If you rate the practice, we email the usefulness score, readiness choice, role category, interview score, question count and language to the Muqabala team. We do not include your name, email address, answer text, audio or video.' },
    ...
    ar: {
      ...
      sections: [
        ...
        { title: 'تقييمك المجهول', body: 'إذا قيّمت التدريب، نرسل درجة الفائدة واختيار الاستعداد وفئة الوظيفة ودرجة المقابلة وعدد الأسئلة واللغة إلى فريق مقابلة. لا نرسل اسمك أو بريدك الإلكتروني أو نص إجابتك أو الصوت أو الفيديو.' },
