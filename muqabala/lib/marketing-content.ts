...
export const homeCopy: Localised<Record<string, string>> = {
  en: {
    ...
    act1Title: 'Know what a good answer needs',
  ...
  ar: {
    ...
    title: 'تدرّب لمقابلة عملك في الخليج.',
    intro:
      'احصل على ملاحظات واضحة بالعربية أو الإنجليزية. شاهد ما نجح وأضف التفاصيل الناقصة ثم حاول مجدداً.',
    primary: 'جرّب إجابة واحدة مجاناً',
    secondary: 'شاهد مثالاً',
    trust: 'الملاحظات الأولى من دون تسجيل. أكّد بريدك للاحتفاظ بالتقارير الكاملة.',
    ...
    hiringTitle: 'هل توظّف؟ حوّل إعلان الوظيفة إلى مقابلة فيديو من ثمانية أسئلة.',
    hiringBody: 'يتبع المرشحون مخطط الوظيفة نفسه. تراجع كل إجابة وتتخذ القرار.',
...
export const employerCopy: Localised<Record<string, string>> = {
  en: {
    ...
    sub: 'Turn any job advert into an adaptive video interview. Candidates answer in their own words. You make every decision.',
    ...
    how1Body: 'Muqabala builds an eight-question role plan, then asks evidence-based follow-ups when needed.',
    how2Title: 'Send one secure link',
    how2Body: 'Candidates answer on any device in about 25 minutes.',
    ...
    candidate2: 'Up to eight main answers, with short evidence-based follow-ups when needed.',
    ...
    volumeTitle: 'Build your shortlist from answer evidence.',
    volumeSub: 'Paste the advert. Paste the emails. Every candidate follows the same role blueprint in their own words. You review the evidence before deciding.',
    volumePrimary: 'Start a shortlist, free',
    volumeSecondary: 'See a sample report',
  ...
  ar: {
    ...
    sub: 'حوّل أي إعلان وظيفة إلى مقابلة فيديو من ثمانية أسئلة. يجيب المرشحون بكلماتهم. وأنت تتخذ كل قرار.',
    ...
    how1Body: 'نبني خطة من ثمانية أسئلة مركّزة لهذه الوظيفة.',
    how2Title: 'أرسل رابطاً آمناً واحداً',
    how2Body: 'يجيب المرشحون من أي جهاز خلال نحو ٢٥ دقيقة.',
    ...
    candidate2: 'حتى ثماني إجابات رئيسية، مع أسئلة متابعة قصيرة عند الحاجة إلى توضيح الأدلة.',
    ...
    volumeTitle: 'كوّن قائمتك المختصرة من أدلة الإجابات.',
    volumeSub: 'الصق الإعلان. الصق عناوين البريد. يتبع كل مرشح مخطط الوظيفة نفسه بكلماته. وأنت تراجع الأدلة قبل القرار.',
    volumePrimary: 'ابدأ قائمة مختصرة مجاناً',
    volumeSecondary: 'شاهد نموذج تقرير',
  ...
  privacy: {
    en: {
      ...
      sections: [
        ...
        { title: 'Adaptive text interviews', body: 'Muqabala stores answers and evidence in encrypted form for up to 90 days, then deletes them automatically. Account links are held separately. You can delete the interview immediately from its feedback page. We do not use practice data for training without your explicit permission.' },
    ...
    ar: {
      ...
      sections: [
        ...
        { title: 'المقابلات النصية المتكيفة', body: 'يخزن مقابلة الإجابات والأدلة بصورة مشفرة لمدة تصل إلى 90 يوماً ثم يحذفها تلقائياً. تُحفظ روابط الحساب بصورة منفصلة. يمكنك حذف المقابلة فوراً من صفحة الملاحظات. لا نستخدم بيانات التدريب لتدريب الذكاء الاصطناعي من دون إذنك الصريح.' },
