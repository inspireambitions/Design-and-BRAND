...
export const homeCopy: Localised<Record<string, string>> = {
  en: {
    ...
    trust: 'First feedback is free, with no sign-up. Verify your email for full reports. We never score your face, accent or personality.',
  ...
  ar: {
    ...
    trust: 'الملاحظات الأولى مجانية ومن دون حساب. أكد بريدك للتقارير الكاملة. لا نقيّم وجهك أو لهجتك أو شخصيتك.',
...
export const employerCopy: Localised<Record<string, string>> = {
  en: {
    ...
    volumeTitle: 'Review the evidence before you shortlist.',
  ...
  ar: {
    ...
    volumeTitle: 'راجع الأدلة قبل إعداد قائمتك المختصرة.',
