  ...
  },
  {
    ...
    questions: [
      ...
      q(
        ...
        ['evidence', 'communication'],
        'Name the real systems — Aconex, SharePoint, EDMS — and your numbering conventions.',
        'اذكر الأنظمة الحقيقية — أكونيكس، شيربوينت، أنظمة إدارة الوثائق — وطريقة الترقيم لديك.',
        20,
        90,
      ),
      q(
