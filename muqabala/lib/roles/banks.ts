...
export const serviceBank: Question[] = [
  q(
    'svc_worst_day',
    'How did you handle a shift when everything went wrong at once?',
  ...
  q(
    ...
    'Tell me about a colleague you found difficult to work with?',
  ...
  q(
    'svc_regular',
    'Tell me about a customer or guest you served often?',
  ...
  q(
    'svc_two_customers',
    'What do you do when two customers need you at the same time?',
...
export const technicalBank: Question[] = [
  ...
  q(
    'tec_hard_deadline',
    'How did you complete a job with a hard deadline?',
    'حدثني عن عمل كان يجب إنهاؤه في موعد نهائي صارم. كيف أنجزته؟',
    ['ownership', 'problem_solving', 'evidence'],
  ),
  q(
    'tec_cut_corners',
    'Tell me about a time you were pushed to cut corners?',
...
export const careBank: Question[] = [
  ...
  q(
    'care_mistake_bank',
    'Tell me about a mistake in your work?',
  ...
  q(
    'care_outside_role',
    'Tell me about a time you were asked to do something outside your role?',
