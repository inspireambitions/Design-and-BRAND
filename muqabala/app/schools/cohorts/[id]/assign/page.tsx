...
export default async function AssignPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { data: questions, error } = await client
    ...
    .select('id,role_id,question_text,rubric')
  ...
  return (
    <>
      <h1>Create Interview Assignment</h1>
      <p>Configure career practice questions, rubric criteria, and instructions for this cohort.</p>
