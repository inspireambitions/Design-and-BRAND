...
- Automated regression suite: 596 passed at the initial full run; final release run recorded below.
...
Release verification is in progress. Final revision, deployment, email receipts and private-link state will be recorded after they are verified.
