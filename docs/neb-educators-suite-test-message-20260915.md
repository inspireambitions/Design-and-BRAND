...
1. **Educator:** sign in; open the assigned institution and cohort; approve or select questions; create an assignment; enrol a learner; check dashboard counts; open submitted work; review evidence; correct an element with a reason; add a comment; undo and save; handle a support request.
...
The pass is complete only when all three roles finish their journeys, both physical phones are covered, no cross-role or cross-institution disclosure occurs, saved answers survive interruption, submission remains exactly once, and the educator can review the learner's final attempt.
